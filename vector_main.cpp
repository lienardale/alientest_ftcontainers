...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/29 21:21:54 by alienard          #+#    #+#             */
/*   Updated: 2021/05/21 13:44:22 by alienard@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
sixth.push_back(2645);
  ...
  ft::vector<int> seven (myints3, myints3 + sizeof(myints3) / sizeof(int) );
  std::cout << "The contents of seven are:";
  for (ft::vector<int>::iterator it = seven.begin(); it != seven.end(); ++it)
    std::cout << ' ' << *it;
  std::cout << '\n';
...
seven.push_back(2645);
  ...
  std::cout << '\n';
        ...
        int myints4[] = {16};
  ft::vector<int> eight (myints4, myints4 + sizeof(myints4) / sizeof(int) );
  std::cout << "The contents of eight are:";
  for (ft::vector<int>::iterator it = eight.begin(); it != eight.end(); ++it)
    std::cout << ' ' << *it;
  std::cout << '\n';
...
///
  ...
  for (ft::vector<int>::iterator it = nine.begin(); it != nine.end(); ++it)
    std::cout << ' ' << *it;
  std::cout << '\n';
...
nine.push_back(2645);
  ...
  ft::vector<int> ten (myints5, myints5 + sizeof(myints5) / sizeof(int) );
    std::cout << "The contents of ten are:";
  for (ft::vector<int>::iterator it = ten.begin(); it != ten.end(); ++it)
    std::cout << ' ' << *it;
  std::cout << '\n';
