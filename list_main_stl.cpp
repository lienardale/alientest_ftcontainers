...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/03/15 15:07:09 by alienard          #+#    #+#             */
/*   Updated: 2021/05/21 13:36:19 by alienard@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_splice(){
  ...
  for ( std::list<int>::iterator  it2=mylist1.begin(); it2!=mylist1.end(); ++it2)
    std::cout << ' ' << *it2;
  std::cout << '\n';
...
int	main(){
	...
	std::list<int> tmp;
	std::list<int>::iterator p = tmp.begin();
	ft_create(tmp, p);

	std::cout << "Fill constructor test." << std::endl;
	std::list<int> tmp2(42,42);
	p = tmp2.begin();
	ft_create(tmp2, p);

	std::cout << "Range constructor test." << std::endl;
	std::list<int> tmp3(tmp.begin(), tmp.end());
	p = tmp3.begin();
	ft_create(tmp3, p);

	std::cout << "Copy constructor test." << std::endl;
	std::list<int> tmp4 = tmp3;
	p = tmp4.begin();
	ft_create(tmp4, p);
