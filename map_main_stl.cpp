...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/21 16:49:40 by alienard          #+#    #+#             */
/*   Updated: 2021/05/21 13:37:52 by alienard@st      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_map(std::map<Key,T> *first){
...
void	ft_print_map(std::map<Key,T,Compare> first){
	for (std::map<char, int>::iterator it = first.begin(); it != first.end() ; it++) {
		std::cout<< "first : " << it->first << " | second : " << it->second << std::endl;
	}
	std::cout << std::endl;
...
void	ft_assign_op(){
	std::map<char,int> first;            // default constr
...
void	ft_constructor_w_ptr_as_comp(){
	...
	std::map<char,int,bool(*)(char,char)> first (fn_pt); // function pointer as Compare
	ft_print_map(first);
	first['z']=42;
	ft_print_map(first);
	first['a']=10;
...
void	ft_range_constructor(){
	...
	std::map<char,int>::iterator itb = first.begin();
	std::map<char,int> third (itb,ite);
	ft_print_map(&third);
